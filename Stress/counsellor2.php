			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h1 class="white-text">Everly Pattinson</h1>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div id="main" class="col-md-9">
						...
						<div class="row">
                            <h2>Education</h2> 
                            <!-- row -->
							<p style="font-size:16px;" >M.Phil. Educational Psychology, MSc. - Child Psychology TherapistEducational Psychologist, Child Behavior Therapist from Haward University</p>
							</div>
                            <!-- /row -->
                            ...
                            <div class="row">
							<h2>Experience</h2>
							<p style="font-size:16px;">16 Years Experience Overall  (15 years as specialist)</p>
							<p> Worked With <p>
