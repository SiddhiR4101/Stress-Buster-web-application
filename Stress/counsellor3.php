			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h1 class="white-text">Lincoln Penn</h1>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div id="main" class="col-md-9">
						...
						<div class="row">
                            <h2>Education</h2> 
                            <!-- row -->
							<p style="font-size:16px;" >MA - Psychology TherapistCounselling Psychologist from  Princeton University </p>
							</div>
                            <!-- /row -->
                            ...
                            <div class="row">
							<h2>Experience</h2>
							<p style="font-size:16px;">9 Years Experience Overall</p>
                            </div>
